...
path = 'C:\\workspace\\GitHub\\DownPython\\porn\\all\\原创自拍区\\'
preUrl = 'https://f.wonderfulday30.live/'
temp = 0
for i in range(1, 13):
    print('第' + str(i) + '页')
    url = "https://91dizhi-at-gmail-com-0201.p17.rocks/forumdisplay.php?fid=4&orderby=dateline&filter=2592000&page=" + str(
        i)
    print(url)
