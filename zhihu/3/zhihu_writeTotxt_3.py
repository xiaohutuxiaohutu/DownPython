...
doneDownPath = 'C:/workspace/GitHub/DownPython/zhihu/doneDown.text'
...
if __name__ == '__main__':
    os.chdir(curDir)
    question_id = 307656249
    with open('C:/workspace/GitHub/DownPython/zhihu/question_id.text', 'a+') as f:
        f.seek(0, 0)
